    ...
    <div className="flex flex-col w-full min-h-screen">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="space-y-5">
            ...
            <section className="bg-[#fbf3e7] border border-stone-700/10 rounded-xl p-5 sm:p-6">
              <div className="max-w-xl">
                <div className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-stone-700 shrink-0" aria-hidden="true">
                  ...
                  <h2 className="text-base font-semibold text-stone-900">Scan Apple Wallet card</h2>
                </div>
          ...
          <section className="bg-[#fbf3e7] border border-stone-700/10 rounded-xl p-5 sm:p-6">
            <div className="max-w-xl">
              <h2 className="text-base font-semibold text-stone-900">Add a stamp</h2>
              <p className="text-sm text-stone-500 mt-1 mb-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <div key={s.label} className="bg-[#fbf3e7] border border-stone-700/10 rounded-xl px-4 py-3.5">
                <div className="flex items-center gap-1.5 text-stone-500 text-[13px]">
          ...
          <section className="bg-[#fbf3e7] border border-stone-700/10 rounded-xl overflow-hidden">
            <div className="px-5 sm:px-6 py-4 border-b border-stone-700/10 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex items-baseline gap-2">
                <h2 className="text-base font-semibold text-stone-900">Customers</h2>
                          ...
                          <div className="flex items-center gap-2 w-28">
                            <div className="flex-1 h-1.5 rounded-full bg-stone-700/10 overflow-hidden">
                              <div
                                ...
                                style={{ width: `${(customer.stampCount / 10) * 100}%` }}
                              />
                            </div>
                            <span className="text-xs text-stone-500 tabular-nums">{customer.stampCount}/10</span>
                          </div>
                        </td>
                        <td className="px-4 py-3.5 text-sm text-stone-700 tabular-nums">{customer.totalScans}</td>
                        <td className="px-4 py-3.5 text-sm text-stone-700 tabular-nums">{customer.totalRewards}</td>
                        <td className="px-4 py-3.5">
                          {customer.rewardActive ? (
                            <span className="inline-flex items-center gap-1.5 text-xs text-green-700 bg-green-100/60 border border-green-300/60 px-2 py-0.5 rounded-full">
          ...
          <section className="bg-transparent border-t border-stone-700/10 pt-6 mt-2">
            <h2 className="text-base font-semibold text-stone-900">Shop logo</h2>
            <p className="text-sm text-stone-500 mt-1 mb-4">Appears on your dashboard, scan page, and QR poster.</p>
